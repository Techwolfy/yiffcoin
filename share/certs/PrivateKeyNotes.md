...
unlocked to sign the Yiffcoin-Qt.app bundle.
...
allowing somebody to distribute a Yiffcoin-Qt.app or yiffcoin-qt-setup.exe with a valid
...
that the yiffcoin-qt.exe file inside the installer had not been tampered with.
