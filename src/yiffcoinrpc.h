...
#ifndef _YIFFCOINRPC_H_
#define _YIFFCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Yiffcoin is not connected
...
/**
 * Yiffcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
