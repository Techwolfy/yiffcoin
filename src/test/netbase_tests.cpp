...
{
    BOOST_CHECK(TestSplitHost("www.yiffcoin.org", "www.yiffcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.yiffcoin.org]", "www.yiffcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.yiffcoin.org:80", "www.yiffcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.yiffcoin.org]:80", "www.yiffcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6933", "127.0.0.1", 6933));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6933", "127.0.0.1", 6933));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6933", "::ffff:127.0.0.1", 6933));
    BOOST_CHECK(TestSplitHost("[::]:6933", "::", 6933));
    BOOST_CHECK(TestSplitHost("::6933", "::6933", -1));
    BOOST_CHECK(TestSplitHost(":6933", "", 6933));
    BOOST_CHECK(TestSplitHost("[]:6933", "", 6933));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6933", "127.0.0.1:6933"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6933", "[::]:6933"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
