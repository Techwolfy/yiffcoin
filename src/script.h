...
#ifndef H_YIFFCOIN_SCRIPT
#define H_YIFFCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CYiffcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Yiffcoin always counted CHECKMULTISIGs
