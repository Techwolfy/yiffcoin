    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new YiffcoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->yiffcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Yiffcoin."), QMessageBox::Ok);
