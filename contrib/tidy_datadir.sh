...
case $LEVEL in
  0)
    echo "Error: no Yiffcoin datadir detected."
    exit 1
    ;;
  1)
    echo "Detected old Yiffcoin datadir (before 0.7)."
    echo "Nothing to do."
    exit 0
    ;;
  2)
    echo "Detected Yiffcoin 0.7 datadir."
    ;;
  3)
    echo "Detected Yiffcoin pre-0.8 datadir."
    ;;
  4)
    echo "Detected Yiffcoin 0.8 datadir."
    ;;
esac
